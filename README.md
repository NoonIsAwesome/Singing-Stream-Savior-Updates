...
Current stable release: **[2.1.0.2](https://github.com/NoonIsAwesome/Singing-Stream-Savior-Updates/releases/tag/v2.1.0.2)**

Official guide and download page: **[Singing Stream Savior Manual](https://noonisawesome.github.io/Singing-Stream-Savior-Manual/)**

- The 2.1.0.2 full installation ZIP includes launcher **1.2.0.0**.
